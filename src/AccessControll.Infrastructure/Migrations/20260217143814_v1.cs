        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DoorAccessLogs_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllowedFromTime = table.Column<TimeSpan>(type: "TEXT", nullable: true),
                    AllowedToTime = table.Column<TimeSpan>(type: "TEXT", nullable: true),
                    GrantedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    GrantedByUserId = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserDoorPermissions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserDoorPermissions_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserDoorPermissions_Doors_DoorId",
                        column: x => x.DoorId,
                        principalTable: "Doors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DoorAccessLogs_AccessedAt",
                table: "DoorAccessLogs",
                column: "AccessedAt");

            migrationBuilder.CreateIndex(
                name: "IX_DoorAccessLogs_DoorId_AccessedAt",
                table: "DoorAccessLogs",
                columns: new[] { "DoorId", "AccessedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_DoorAccessLogs_UserId_AccessedAt",
                table: "DoorAccessLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserDoorPermissions_DoorId",
                table: "UserDoorPermissions",
                column: "DoorId");

            migrationBuilder.CreateIndex(
                name: "IX_UserDoorPermissions_UserId_DoorId",
                table: "UserDoorPermissions",
                columns: new[] { "UserId", "DoorId" },
                unique: true);
        }
